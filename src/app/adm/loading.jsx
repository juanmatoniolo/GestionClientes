// app/adm/clientes/loading.jsx
import styles from "./loading.module.css";

export default function Loading() {
    return (
        <div aria-label="Cargando..." role="status" className={styles.loader}>
            <svg className={styles.icon} viewBox="0 0 256 256" fill="none">
            ...
            <span className={styles.loadingText}>Puto el que lee</span>
        </div>
    );
}
